...
class StepAudioSeparate(StepBase):
    ...
    def run(self, workspace: Path, config: Dict[str, Any], job_state: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [sys.executable, "-m", "demucs.separate", "--two-stems", "vocals"] + device_flag + ["-o", str(audio_dir), str(audio_stream)]
            print(f"[AudioSeparate] Running AI Demucs audio separation...")
