...
# Python Standalone Release details (indygreg python-build-standalone)
...
echo "🍏 Bắt đầu đóng gói Embedded Standalone Python vào SubVideo.app..."
...
echo "🎉 HOÀN TẤT ĐÓNG GÓI EMBEDDED PYTHON VÀO SubVideo.app!"
