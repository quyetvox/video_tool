#!/usr/bin/env bash
# ==============================================================================
# Sub-Video AI: One-Click Machine Setup Script (macOS)
...
elif [ -d "flutter_app/build/macos/Build/Products/Release/SubVideo.app" ]; then
    echo "💻 Đang cài đặt SubVideo vào Launchpad (/Applications)..."
    cp -R "flutter_app/build/macos/Build/Products/Release/SubVideo.app" /Applications/
    xattr -cr "/Applications/SubVideo.app" 2>/dev/null || true
fi
